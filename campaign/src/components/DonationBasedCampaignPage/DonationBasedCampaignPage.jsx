...
import "./DonationBasedCampaignPage.scss";

// import DonationCampaignImg from "../../Assets/Images/DonationCampaignImg.png";
...
const DonationBasedCampaignPage = () => {
                ...
                <div className="payment_card">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="quotes">
                      ...
                      <p>Support the needy people. Just because it speaks to you</p>
                    </div>
...
export default DonationBasedCampaignPage
